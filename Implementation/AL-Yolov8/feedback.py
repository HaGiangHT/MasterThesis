...
def read_from_csv(current_training_number):
    ...
    if current_training_number is not None and int(current_training_number) >= 5:#5
        csv_file_path_current = f'./runs/detect/train{current_training_number}/class_metrics.csv'
        ...
        df_minus_1 = pd.read_csv(f'./runs/detect/train{training_number_minus_1}/class_metrics.csv')
        df_minus_2 = pd.read_csv(f'./runs/detect/train{training_number_minus_2}/class_metrics.csv')
        ...
        if current_training_number == 5:
            ...
            with open(f"./runs/detect/train{training_number_minus_1}/new_balancing.json", "r") as file:
                data = json.load(file)
        ...
        dest_path = os.path.join(f'./runs/detect/train/new_balancing.json')
        # Copy the file
        shutil.copyfile(src_path, dest_path)
    else:
        src_path = os.path.join('./initial_balancing.json')
        dest_path = os.path.join(f'./runs/detect/train{current_training_number}/new_balancing.json')
        # Copy the file
        shutil.copyfile(src_path, dest_path)
...
def update_value(updates, current_training_number):
    ...
    with open(f"./runs/detect/train{current_training_number}/new_balancing.json", "w") as file:
