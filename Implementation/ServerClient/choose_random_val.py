...
with open('Server_Client_NoneF/val_images.txt', 'a') as f:
    i = 0
    original_folder = './Server_Client_NoneF/nuimages-samples/images/val'
    new_folder = './Server_Client_NoneF/traindata/images/val'
